        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#featured" className="text-slate-300 hover:text-white transition-colors">Free Resources</a></li>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-slate-300 hover:text-white transition-colors">My Progress</a></li>
              <li><a href="#" className="text-slate-300 hover:text-white transition-colors">Study Notes</a></li>
